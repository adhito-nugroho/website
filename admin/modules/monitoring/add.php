        ...
        if (empty($errors)) {
            ...
            $stmt = $pdo->prepare("
                INSERT INTO monitoring (
                    date, location, activity, status, description, 
            ...
            logAdminActivity($_SESSION['user_id'], 'create', $pdo->lastInsertId(), 'Menambahkan data monitoring baru');

            // Simpan pesan sukses ke session
            $_SESSION['success_message'] = 'Data monitoring berhasil ditambahkan';
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Tambah Monitoring</h4>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Form Tambah Monitoring</h4>
