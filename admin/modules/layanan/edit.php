...
// Removed CSRF token generation and debug
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Edit Layanan</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="mb-3 row">
                                <label for="title" class="col-md-2 col-form-label">Judul Layanan <span class="text-danger">*</span></label>
                                <div class="col-md-10">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="mt-2">
                                        <i id="iconPreview" class="<?php echo htmlspecialchars($icon); ?> fa-2x"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control" id="order_number" name="order_number" value="<?php echo (int)$order_number; ?>">
                                </div>
                            </div>
