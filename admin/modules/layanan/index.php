...
try {
    $stmt = $pdo->query("SELECT * FROM services ORDER BY order_number");
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Manajemen Layanan</h4>
            </div>
                                    ...
                                    <?php if (count($services) > 0): ?>
                                        <?php foreach ($services as $index => $service): ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $service['order_number']; ?></td>
                                                <td class="text-center">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus layanan "<span id="delete-name"></span>"?</p>
