...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $stmt->execute([$title, $icon, $description, $content, $order_number, $is_active, $id]);

            // Redirect ke halaman program dengan pesan sukses
            $_SESSION['message'] = 'Program berhasil diperbarui';
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Edit Program</h4>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Form Edit Program</h4>
                        <form action="" method="post">
                            <div class="mb-3 row">
                                <label for="title" class="col-md-2 col-form-label">Judul Program <span class="text-danger">*</span></label>
                                <div class="col-md-10">
                            ...
                            <div class="mb-3 row">
                                <label for="icon" class="col-md-2 col-form-label">Icon <span class="text-danger">*</span></label>
                                <div class="col-md-10">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="icon" name="icon" value="<?php echo htmlspecialchars($icon); ?>" required>
                                        <button class="btn btn-outline-secondary" type="button" id="iconPicker">Pilih Icon</button>
                                    </div>
                                    <small class="form-text text-muted">Gunakan kelas icon dari Font Awesome atau Remix Icon, contoh: ri-draft-line, fas fa-tree</small>
                                    <div class="mt-2">
                                        <span>Preview: <i id="iconPreview" class="<?php echo htmlspecialchars($icon); ?> fa-2x"></i></span>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="mb-3 row">
                                <label for="description" class="col-md-2 col-form-label">Deskripsi Singkat <span class="text-danger">*</span></label>
                                <div class="col-md-10">
                            ...
                            <div class="mb-3 row">
                                <label for="content" class="col-md-2 col-form-label">Konten <span class="text-danger">*</span></label>
                                <div class="col-md-10">
                                    <textarea class="summernote" id="content" name="content"><?php echo htmlspecialchars($content); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control" id="order_number" name="order_number" value="<?php echo (int)$order_number; ?>" min="0">
                                    <small class="form-text text-muted">Menentukan urutan tampilan program (terkecil ditampilkan pertama)</small>
                                </div>
                            </div>
